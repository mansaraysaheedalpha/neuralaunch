  ...
  const journey = [
    {
      year: "2024",
      title: "The Beginning",
      description: "NeuraLaunch was born from the frustration of seeing too many startups fail by building products nobody wanted.",
      icon: Sparkles,
    },
    {
      year: "Q1",
      title: "AI Blueprint Launch",
      description: "Launched our AI-powered startup blueprint generator, helping founders create comprehensive validation plans.",
      icon: BrainCircuit,
    },
    {
      year: "Q2",
      title: "Validation Sprint",
      description: "Introduced the 72-hour validation sprint framework, revolutionizing how founders test assumptions.",
      icon: Clock,
    },
    {
      year: "Present",
      title: "Global Impact",
      description: "Empowering founders worldwide with AI-driven insights and structured validation methodologies.",
      icon: Globe,
    },
  ];
  ...
  return (
    <div className="pt-20 min-h-screen bg-background relative overflow-hidden">
      ...
      <div className="fixed inset-0 -z-10 overflow-hidden pointer-events-none">
        ...
        <div className="absolute bottom-0 -right-1/4 w-1/2 h-1/2 bg-secondary/5 rounded-full blur-[120px] animate-pulse" style={{ animationDelay: '1s' }} />
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-1/3 h-1/3 bg-accent/5 rounded-full blur-[100px] animate-pulse" style={{ animationDelay: '2s' }} />
      </div>

      {/* Hero Section with 3D Effects */}
      <section ref={heroRef} className="relative overflow-hidden py-32 px-4 sm:px-6 lg:px-8">
        <motion.div
        ...
        >
          ...
          <motion.h1
            variants={fadeInUp}
            className="text-6xl md:text-7xl lg:text-8xl font-black tracking-tight mb-6 bg-gradient-to-r from-primary via-secondary to-accent bg-clip-text text-transparent"
          >
            About NeuraLaunch
          </motion.h1>
          ...
          >
            <p className="text-2xl md:text-3xl text-muted-foreground max-w-4xl mx-auto mb-8 leading-relaxed">
              ...
              <span className="text-primary font-semibold">AI-powered precision</span>.
          ...
          >
            ...
            >
              ...
              <h2 className="text-5xl md:text-6xl font-bold tracking-tight text-foreground mb-6">
                ...
                <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent"> Startup Validation</span>
              </h2>
            </motion.div>
            ...
            >
              ...
              <div className="relative z-10">
                <p className="text-xl md:text-2xl text-muted-foreground leading-relaxed mb-6">
                  ...
                  NeuraLaunch exists to change that narrative.
                </p>
                <p className="text-lg md:text-xl text-muted-foreground leading-relaxed">
                  We empower founders to validate their ideas rigorously before committing time and
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">From vision to reality</p>
            </motion.div>
      ...
      <section className="py-20 px-4 sm:px-6 lg:px-8 relative">
        <div className="max-w-7xl mx-auto">
          ...
          >
            ...
            >
              What Makes Us <span className="bg-gradient-to-r from-primary to-secondary bg-clip-text text-transparent">Different</span>
            </motion.h2>
            <motion.div
              variants={staggerContainer}
              ...
              {[
                {
                  ...
                  description: "Input your skills, passions, or initial idea. Our AI analyzes your unique potential and generates tailored startup opportunities.",
                  icon: Sparkles,
                ...
                },
                {
                  ...
                  description: "Get a comprehensive startup plan covering validation strategy, go-to-market approach, competitive moat, and unit economics projections.",
                  icon: BrainCircuit,
                ...
                },
                {
                  ...
                  description: "Follow a structured 72-hour validation plan with AI assistance to test your core assumptions and gather real-world feedback.",
                  icon: Rocket,
                ...
                >
                  ...
                  <div className="flex-1 relative">
                    ...
                    <h3 className="text-2xl md:text-3xl font-bold text-foreground mb-3 flex items-center gap-3">
                      {item.title}
                      <span className="text-sm text-muted-foreground font-normal">Step {item.step}</span>
                    </h3>
        ...
        <div className="max-w-6xl mx-auto">
          ...
          >
            <motion.div variants={fadeInUp} className="text-center mb-16">
              ...
              <p className="text-xl text-muted-foreground">Cutting-edge tools for cutting-edge solutions</p>
            </motion.div>
            <motion.div
              variants={staggerContainer}
            ...
            >
              {techStack.map((stack, index) => (
                ...
                >
                  {/* Animated Background */}
                  <div className={`absolute inset-0 bg-gradient-to-br ${stack.color} opacity-0 group-hover:opacity-10 rounded-2xl blur-xl transition-opacity duration-500`} />
                  
                  {/* Card */}
                  <div className="relative bg-card/50 backdrop-blur-sm border border-border/50 rounded-2xl p-8 shadow-lg h-full">
                    <div className="flex items-center gap-4 mb-6">
                      <div className={`w-14 h-14 bg-gradient-to-br ${stack.color} rounded-xl flex items-center justify-center shadow-lg`}>
                    ...
                    <ul className="space-y-3">
                      {stack.technologies.map((tech, techIndex) => (
                        ...
                        >
                          ...
                          <span className="group-hover/item:text-foreground transition-colors">{tech}</span>
                        </motion.li>
                      ))}
                    </ul>
                  </div>
