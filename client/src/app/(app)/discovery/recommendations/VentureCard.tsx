      ...
      >
        <div className="flex-1 min-w-0 flex flex-col gap-1.5">
          <div className="flex items-center gap-2">
            <p className="text-sm font-semibold text-foreground truncate">{venture.name}</p>
          ...
          >
            <div className="border-t border-border px-4 py-3 flex flex-col gap-2">
              {venture.cycles.map(cycle => {
                ...
                const href = cycle.roadmapId
                  ? `/discovery/roadmap/${cycle.roadmapId}`
                  : null;
                ...
                return href ? (
                  ...
                  >
                    ...
                    <span className="truncate">
                      ...
                      {cycle.selectedForkSummary ? `: ${cycle.selectedForkSummary}` : ''}
                    </span>
                  ...
                  <div
                    key={cycle.id}
                    className="flex items-center gap-2 rounded-md px-2.5 py-1.5 text-[11px] text-muted-foreground"
                  >
