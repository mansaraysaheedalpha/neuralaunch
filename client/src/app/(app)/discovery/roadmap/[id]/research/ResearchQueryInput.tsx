  ...
  return (
    <div className="flex flex-col gap-3">
      ...
      <textarea
        ...
        className="w-full rounded-md border border-border bg-background px-3 py-2 text-xs text-foreground placeholder:text-muted-foreground/60 disabled:opacity-50 outline-none focus:ring-2 focus:ring-primary/30 resize-none leading-relaxed"
      />
