      ...
      {!capped && (
        <div className="flex gap-2">
          <input value={draft} onChange={e => setDraft(e.target.value)}
            ...
            className="flex-1 rounded-md border border-gold/30 bg-background px-2 py-1.5 text-xs text-foreground disabled:opacity-50 outline-none focus:ring-2 focus:ring-gold/30"
          />
