...
const ExtractionResultSchema = z.object({
  inputType: z.enum(['answer', 'offtopic', 'frustrated', 'clarification', 'synthesis_request']).describe(
    'answer: user responded to the question (even vaguely — uncertainty about their own situation still counts as answer). offtopic: user asked who you are, how this works, or any meta/unrelated question. frustrated: user expressed annoyance, resistance, or dismissal ("stop", "I don\'t know", "why do you keep asking", "pointless", "whatever"). clarification: user is asking whether they understood the QUESTION correctly before answering it — e.g. "if I get you right, you\'re asking about X?", "what do you mean by Y?", "are you asking about Z?", "so you want to know...?". Only use clarification when the user has NOT provided any answer content — they are purely seeking confirmation of what was asked. synthesis_request: user is explicitly asking to end the interview and generate the recommendation NOW — "generate the recommendation", "give me the result", "enough questions", "just give me the recommendation", "I won\'t answer any more", "can you just make the plan".',
  ),
...
- "synthesis_request": the user is explicitly asking to end the interview and generate the recommendation NOW — e.g. "generate the recommendation", "give me the result", "enough questions", "just give me the plan", "I won't answer any more questions".
