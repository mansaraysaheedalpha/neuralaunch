...
export const RecommendationSchema = z.object({
  ...
  reasoning: z.string().min(50).describe(
    'Detailed explanation of why this path fits this person. Must reference specific details from their context.'
  ),

  /** The first 3 concrete, actionable steps — sequenced correctly */
  firstThreeSteps: z.array(z.string().min(5)).min(3).max(3).describe(
   ...
   */
  whatWouldMakeThisWrong: z.string().min(20),
